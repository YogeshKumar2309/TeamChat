  ...
  return (
    <div className="h-full grid grid-cols-1">
      ...
      <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
              {page > 1 && (
                <button
                  ...
                  className="w-full py-2 text-xs text-purple-600 hover:text-purple-700 font-medium"
                >
                  Load older messages
                </button>
              )}

              {(messages[currentChannel.id] || []).map((msg) => (
                <div key={msg.id} className="flex gap-3 items-start">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-800 mt-1">{msg.text}</p>
                  </div>
                </div>
              ))}
        ...
        {/* Optional Online Users Bar at Bottom if needed */}
        {onlineUsers && (
